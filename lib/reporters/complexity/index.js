...
async function process(source, options, reportInfo) {
  let babelOptions = options?.parserOptions?.babelOptions
	var report = await escomplex.analyzeModule(source, options, babelOptions);
